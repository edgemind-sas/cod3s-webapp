...
async function refreshTable() {
  try {
    ...
    const response2 = await modelService.fetchSequences();
    ...
    sequences.value = response2.sequence.transitions;
  } catch (error) {
...
const startSimulation = simulationStore.startSimulation;
const goBackward = simulationStore.goBackward;
const goForward = simulationStore.goForward;
